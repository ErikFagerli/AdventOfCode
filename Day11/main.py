        ...
        for item in all_monkeys[monkey]:
            ...
            if monkey == 0:
                ...
                if item_temp % 11 == 0:
                    ...
                    all_monkeys[monkey].remove(item)
                else:
...
# 101436 is the answer to part 1

print(M0_count, M1_count, M2_count, M3_count, M4_count, M5_count, M6_count, M7_count)